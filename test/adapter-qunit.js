	...
	var createQUnitStartFn = function() {
		...
		QUnit.log(function(details) {
			if (!details.result) {
				...
				if (details.actual !== undefined) result.push('Actual: \033[0;31m' + details.actual + '\033[0m');
				if (details.expected !== undefined) result.push('Expected:  \033[0;32m' + details.expected + '\033[0m');
